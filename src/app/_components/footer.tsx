...
export const Footer = () => {
  ...
  return (
    <footer className="container mx-auto border-t border-gray-800 bg-gray-900/50 px-6 backdrop-blur-lg">
      <div className="grid grid-cols-1 gap-12 pt-12 md:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-gray-400">
            The ultimate template for building modern web applications with Next.js and TypeScript.
          </p>
        </div>
