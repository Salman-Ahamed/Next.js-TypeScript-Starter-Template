...
import { BackgroundGrid, CodeBlock, GuideCard, GuideList, GuideSection } from "./_components";
    ...
    <div className="min-h-screen overflow-hidden bg-gray-950 text-gray-100">
      ...
      <div className="relative container mx-auto max-w-4xl px-4 py-8">
        <div className="mb-4 flex justify-center">
          <Link
            href="/"
            className="inline-flex items-center gap-1 rounded-full px-3 py-1.5 text-sm font-medium text-indigo-400 transition-colors hover:bg-gray-800/60 hover:text-indigo-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        ...
        <h1 className="mb-8 text-center text-4xl font-bold">Developer Guide</h1>
